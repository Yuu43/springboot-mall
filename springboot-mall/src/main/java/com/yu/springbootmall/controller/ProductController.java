...
@Validated   // **若有 @Max 或 @Min 則需要加上 @Validated 才會生效
@RestController
public class ProductController {
    ...
    public ResponseEntity<Page<Product>> getProducts(
            ...
            //分頁 Pagination
            @RequestParam(defaultValue = "5") @Max(1000) @Min(0) Integer limit,    // limit 5，代表取得前5筆資料
            @RequestParam(defaultValue = "0") @Min(0) Integer offset               // offset 2，代表跳過前兩筆資料
    ) {
    ...
    public ResponseEntity<Product> updateProduct(@PathVariable Integer productId,
        ...
        //修改商品數據
        productService.updateProdcut(productId, productRequest);
